...
## Confidential: Making TEEs Production-Ready
...
Confidential exists to solve this. We're building the standards, tooling, and infrastructure necessary to make using TEEs simple and seamless.
