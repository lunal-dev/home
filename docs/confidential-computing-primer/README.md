...
- Explain what Confidential's TEE infrastructure protects against and what it doesn't
...
- Understand how Confidential extends trust from hardware measurement to your application code
